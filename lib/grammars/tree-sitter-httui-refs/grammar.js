 ...
 * grammars-lezer/lezer-httui-refs/ emits a lexical coarsening of these
...
module.exports = grammar({
  ...
  rules: {
    ...
    ref_body: ($) => seq(choice($.identifier, $.prev), optional($.dot_path)),

    dot_path: ($) => repeat1(seq(".", $.path_segment)),

    path_segment: ($) =>
      seq(choice($.identifier, $.number), optional($.index_access)),
